<template>
  <div class="search-dashboard">
    ...
    <div class="search-header sticky top-0 z-10 px-4 pt-4 pb-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
      ...
      <div class="relative mb-3">
        <input
          ...
          v-model="searchQuery"
          @input="handleSearch"
          placeholder="Buscar colonia, calle o nombre..."
    ...
    <div v-else-if="filteredTianguis.length > 0" class="p-4 dark:bg-gray-900">
      ...
      <div class="flex flex-col gap-4">
        <TianguisCard
          v-for="tianguis in filteredTianguis"
          :key="`${tianguis.name}-${tianguis.day}`"
          :tianguis="tianguis"
        />
      </div>
    </div>
