<template>
  ...
  >
    <div class="flex justify-between items-start">
      <div class="flex-1">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">
          <span class="inline-block px-2 py-0.5 bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 rounded text-xs font-medium mr-2 border border-transparent dark:border-blue-800/50">
    ...
    <a
      :href="`/mapa?lat=${tianguis.lat}&lng=${tianguis.lng}&name=${encodeURIComponent(tianguis.name)}`"
